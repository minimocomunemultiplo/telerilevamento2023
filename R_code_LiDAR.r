...
# turn it to a dataframe, otherwise the plotting won't be successfull
...
writeRaster(chm_2013,"chm_2013_San_genesio.tif") # writeRaster from raster package lets you save pics with different ext.


# LET'S DO THE SAME FOR DSM 2004
...
# reseample 2013 to 2004 @2.5m. With the resample function, the first element is what you resample, the second is the one that 
# functions as standart of resampling.
...
# Save the raster you resampled and their diff.
writeRaster(chm_2013_reseampled,"chm_2013_reseampled_San_genesio.tif")
writeRaster(difference,"difference chm San_genesio.tif")



# Assuming you have a good computer to compute this toughly computable stuff, try to plot it as shown below.
